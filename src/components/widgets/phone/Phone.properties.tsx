  ...
  return (
    <>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <input
          style={inputStyle}
          value={(widget.config.prefix as string) || "+57"}
          onChange={(e) =>
            updateWidget(widget.id, {
              config: { ...widget.config, prefix: e.target.value },
            })
          }
        />
      </div>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <input
          type="number"
          style={inputStyle}
          value={(widget.config.maxLength as number) || 10}
          onChange={(e) =>
            updateWidget(widget.id, {
              config: { ...widget.config, maxLength: parseInt(e.target.value) || 10 },
            })
          }
        />
      </div>
